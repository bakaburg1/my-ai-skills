...
description: >
  ...
  figure and table captions, accessible alt text for data visualizations,
  cross-references, callout blocks (notes, warnings, tips), citations and
  bibliography, page layout and columns, Mermaid diagrams, YAML metadata
  configuration, and Quarto extensions. Also covers converting and migrating R
  Markdown (.Rmd), bookdown, blogdown, xaringan, and distill projects to Quarto,
  and creating Quarto websites, books, presentations, and reports.
metadata:
...
Task: Write accessible alt text for data visualizations
Use: [references/alt-text.md](references/alt-text.md)
...
For chart and figure descriptions, write `fig-alt` text that helps screen reader
users understand the visual without repeating the caption.

- Start with the chart type, then describe the axes or main variables.
- Include color, size, facet, or panel encodings when they carry meaning.
- Add the key pattern or takeaway when the surrounding prose does not already
  state it.
- Keep the description concise and plain-language.

Use the code, captions, and surrounding prose to infer the important details.
Details: [references/alt-text.md](references/alt-text.md)
